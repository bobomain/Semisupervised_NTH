function varargout =  Semi_NTH_NW_testparas_octave(varargin)
...
%将DIST距离矩阵中的距离，由小到大排序
    ...
    num =1;
for gamma1 = [1e-3]
    for gamma2 = [1e-9,1e-3,1e-11,1e-5,1e-7]
        paras.gamma1 = gamma1;
        paras.gamma2 = gamma2;
        ...
        save([dirname_write,'SemiNTH_recRev_g1e3_',int2str(num),'.mat'],'resRev');
        num = num+1;
end
end
end
