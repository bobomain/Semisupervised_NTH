...
much_filename = '/home/lf/much_code/dblp_mongo_vector/Reduc_Hash/MultiNW_';
...
for M =1:4
	...
	for batch = [0:9]
    	   ...
    	   f=load([much_filename,int2str(batch),'/recRev_NWMulti_',int2str(M),'_',int2str(K),'.mat']);	    
...
save(['/home/lf/much_code/dblp_mongo_vector/resRev/mean_result/SemiStageNW_batch09_MResult.mat'],'mean_result');
