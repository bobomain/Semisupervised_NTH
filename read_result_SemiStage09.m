...
much_filename = '/home/lf/much_code/dblp_mongo_vector/Reduc_Hash/MultiLDA_';
...
for M =1:4
	...
	for batch = [0:9]
    	   ...
    	   f=load([much_filename,int2str(batch),'/recRev_dblpMulti_',int2str(M),'_',int2str(K),'.mat']);	    
...
save(['/home/lf/much_code/dblp_mongo_vector/resRev/mean_result/SemiStage_batch09_MResult.mat'],'mean_result');
