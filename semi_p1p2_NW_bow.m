...
function [test_time,train_time]=semi_p1p2_NW_bow(varargin)
t1 = clock;
...
feature_data=load([dirname_load,'train_NW_bow.txt']);
...
filename_train_Hc = [dirname_write,'semi_train_NW_bow','_',int2str(M),'_',int2str(K),'.txt'];
filename_train_Hbinary = [dirname_write,'semi_train_NW_bow_binary','_',int2str(M),'_',int2str(K),'.txt'];
dlmwrite(filename_train_Hc,much_train_Y);
dlmwrite(filename_train_Hbinary,res.H');
test_data = load([dirname_load,'test_NW_bow.txt'])'; %L*N
...
t3=clock;
filename_test_Hc = [dirname_write,'semi_test_NW_bow_',int2str(M),'_',int2str(K),'.txt'];
filename_test_Hbinary = [dirname_write,'semi_test_NW_bow_binary_',int2str(M),'_',int2str(K),'.txt'];
