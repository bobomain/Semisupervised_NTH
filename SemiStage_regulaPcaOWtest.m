function [test_B,train_B]=SemiStage_regulaPcaOWtest(M,K,dirname_write,R,data,paras)

train_data = data.train_data; %L*N
test_data = data.test_data;

res_Reduc = Reduc_regulaStageOW(train_data,R,M*K,paras);
...
paras.alpha = 2/K;
res_Hash=much_regulaSNTH(Hash_train,R_G,M,K,paras)
train_H = res_Hash.H;
W_Hash = res_Hash.W;
