...
for M = [2,3,1,4]
	...
	if  M ~=2 && K~=16
        ...
        save([dirname_write,'SemiNTH_recRev_pp200_g1e5g2e9_',int2str(M),'_',int2str(K),'.mat'],'resRev');
	end
end
end
train_time
