...
much_filename = '/home/lf/much_code/dblp_mongo_vector/Much_Multi/MultiNW_';
...
for M =1:3
	...
	for batch = [0:9]
    	   ...
    	   f=load([much_filename,int2str(batch),'/MultiNW_list500','_',int2str(M),'_',int2str(K),'.mat']);	    
...
save(['/home/lf/much_code/dblp_mongo_vector/resRev/mean_result/MuchNW_batch09_MResult.mat'],'mean_result');
