function varargout = Reduc_Hash_NWMK7(varargin)
...
paralist={[1e-3,1e-9],[1e-5,1e-7],[1e-9,1e-3],[1e-9,1e-7]};
for M=[2,3,4]
	...
	resRev.M = M;
        save([dirname_write,'recRev_NWMulti_Mtest_7pca_',int2str(num),'.mat'],'resRev');
    end
end
